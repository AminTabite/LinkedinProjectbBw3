            ...
            <div className="sticky-top" style={{ top: "80px" }}>
              ...
              <Card className="mb-2 border-0" style={{ backgroundColor: "white", borderRadius: "8px" }}>
                ...
                <Card.Body className="pt-4 px-3 pb-3" style={{ marginTop: "14px" }}>
                  <h6 className="mb-1 fw-semibold d-flex align-items-center" style={{ fontSize: "16px" }}>
                    <span className="me-2">
              ...
              <Card className="mb-2 border-0" style={{ backgroundColor: "white", borderRadius: "8px" }}>
                <Card.Body className="p-3">
                  ...
                  <div className="d-flex align-items-center mt-3" style={{ cursor: "pointer" }}>
                    ...
                    <span className="fw-semibold" style={{ fontSize: "14px", color: "#0a66c2", textDecoration: "underline" }}>
          ...
          <Col lg={9} xs={12}>
                        ...
                        <div className="flex-grow-1 min-width-0">
                          <div className="d-flex align-items-center justify-content-between">
                            <h6 className="mb-0 fw-semibold" style={{ fontSize: "16px", lineHeight: "1.25", color: "#0a66c2" }}>
                              ...
                              >
                                <FaEllipsisH size={16} className="text-muted me-2" />
                              </div>
                              <div 
                                onClick={() => gestisciRimuoviLavoro(lavoro._id)}
                                style={{ cursor: "pointer", padding: "4px" }}
                              >
                                  ...
                                  >
                                    <div className="p-3">
                                      ...
                                      <div className="text-muted small">
                                        Questa offerta è stata selezionata in base al tuo profilo, alle tue preferenze e ad attività come candidature, ricerche e salvataggi precedenti.
                                      </div>
                                    </div>
                                  </div>
                                </>
            ...
            <Card className="border-0 mb-2" style={{ backgroundColor: "white", borderRadius: "8px" }}>
              <Card.Body className="p-3">
                ...
                <div className="d-flex align-items-center mb-3 p-2" style={{ cursor: "pointer", borderRadius: "4px" }}>
                  <div 
                    className="rounded me-3 d-flex align-items-center justify-content-center text-white flex-shrink-0"
                    style={{ 
                      width: "40px", 
                ...
                <div className="d-flex align-items-center p-2" style={{ cursor: "pointer", borderRadius: "4px" }}>
                  <div 
                    className="rounded me-3 d-flex align-items-center justify-content-center text-white flex-shrink-0"
                    style={{ 
                      width: "40px", 
                  ...
                  <div className="flex-grow-1">
                    ...
                    <div className="text-muted small">
                      Migliora le tue possibilità di essere trovato dai recruiter
                    </div>
                  </div>
                </div>
              </Card.Body>
              ...
              <Card.Body className="p-3">
                <div className="d-flex align-items-start">
                  <div className="me-3 flex-shrink-0">
                    <img 
                      src={datiProfilo?.image || "https://via.placeholder.com/48x48/0a66c2/ffffff?text=U"} 
                      alt="Profilo" 
                  ...
                  <div className="flex-grow-1">
                    <h6 className="mb-2 fw-semibold" style={{ fontSize: "16px" }}>
                      Cerca lavoro in modo più smart con Premium
                    </h6>
                    <div className="d-flex align-items-center mb-3">
                      <div className="me-2" style={{ position: "relative", width: "60px", height: "24px" }}>
                        <img 
                    ...
                    <p className="text-muted small mb-0" style={{ fontSize: "11px", lineHeight: "1.3" }}>
