    ...
    <div className="d-flex flex-column gap-3" style={{ width: "18rem" }}>
        ...
        {arrayUtenti && arrayUtenti.length > 5
          ...
          : arrayUtenti &&
            ...
            arrayUtenti
              .filter(
                (_, index) =>
                  [1, 3, 5, 7, 9].includes(index) && arrayUtenti[index]
              )
              .slice(0, 5)
              .map((utente, indice) => (
                <div key={indice} className="d-flex align-items-center mb-2">
      ...
      <div className="border rounded p-3 bg-white d-flex">
        ...
        <div>
          ...
          <p className="small text-muted">
            Bootstrap is an open-source front-end framework that web developers
            use to build mobile-friendly sites and applications. It provides a
            collection of pre-designed templates, CSS styles, and JavaScript
            components to help developers efficiently and effectively create
            visually appealing and consistent web interfaces.{" "}
          </p>
        </div>
      </div>
      ...
      <div className="border rounded p-3 bg-white d-flex mt-3">
        ...
        <div>
          ...
          <p className="small text-muted">
            JavaScript is a text-based scripting language or programming
            language used on both the server-side and client-side to create
            engaging website elements, fully featured web applications, CLI
            applications and even web servers. In short, JavaScript is extremely
            versatile.{" "}
          </p>
        </div>
      </div>
